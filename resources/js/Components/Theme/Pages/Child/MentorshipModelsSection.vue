...
import BooKPaidSession from "@/Components/Theme/Pages/Child/Purchase/BooKPaidSession.vue";
...
const steps = ref([
    ...
    {
        title: "Book Paid Session",
        name: "bookPaidSession",
        component: shallowRef(BooKPaidSession),
        props: {
            title: '',
...
<template>
    <div>
        <TabSecondary class="border-0 tab-wrapper-inner" tabLayout="default" v-model="currentStep" :steps="steps" submit-button-text="Signup" :is-storing-info="form.processing" @validate="" @submit="" @updateData="" header-classes="auth-column-form-box" action-classes="auth-column-form-box" />
    </div>
</template>
